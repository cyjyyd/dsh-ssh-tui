...
export const en: Record<string, string> = {
  ...
  'help.intro2': 'Empty ↑/↓ selects cards (same as Ctrl+N/P); Enter expands (oversized bodies open a full view, Esc returns); Ctrl+R expands the latest card (or all, once a card is selected); Ctrl+T folds input. /copy copies the focused card (or latest reply) to the local clipboard. Slash suggestions and model lists keep 12 rows; ↑/↓ slides the window.',
