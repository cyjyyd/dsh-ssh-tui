...
export const en: Record<string, string> = {
  ...
  'onboard.optCatalog': '  6  Catalog presets — the same directory as the web Models page (MiniMax, Moonshot, OpenRouter, Z.AI, …)',
  'onboard.pickHintCatalog': '  Press 1-6, Esc to cancel',
  'onboard.catalogTitle': 'Catalog presets — type to filter, Enter picks the first match:',
  'onboard.catalogEmpty': '  No matching providers',
  'onboard.catalogHint': '  {count} match(es) · Enter selects · Esc exits the wizard',
  ...
  'cmd.help': 'list slash commands',
  'cmd.model': 'model and reasoning effort for this provider',
  'cmd.provider': 'switch provider, then pick a model',
  'cmd.submodel': 'subagent model (same family as the parent by default)',
  'cmd.subeffort': 'subagent reasoning effort (follows the provider by default)',
  'cmd.mode': 'switch agent mode / preset',
  'cmd.quit': 'exit the TUI',
  'cmd.clear': 'clear the transcript',
  'cmd.status': 'session, route, quota, link, and plugin version',
  'cmd.disconnect': 'on SSH drop: pause or continue in the background',
  'cmd.view': 'workspace view: detailed or compact',
  'cmd.usage': 'balance or remaining quota for this provider',
  'cmd.subagents': 'list subagents; kill <id> to stop one',
  'cmd.resume': 'resume a past session; empty opens the picker',
  'cmd.setup': 'add or update one API-key provider',
  'cmd.find': 'search thinking / plan / subagent / reply cards',
  'cmd.language': 'UI language: Chinese or English',
  'cmd.dialog-test': 'verify the question dialog',
  ...
  'disconnect.cmd': 'on SSH drop: pause or continue in the background',
  'disconnect.pick': 'On SSH drop',
  'disconnect.pause': 'pause',
  'disconnect.continue': 'continue',
  'disconnect.pauseDesc': 'Cancel the turn; keep the Host until you attach and send again',
  'disconnect.continueDesc': 'Let the turn finish in the background; approvals wait for attach',
  ...
  'help.intro8': '/disconnect pause (default) cancels the turn on SSH drop; /disconnect continue finishes it in the background and defers approvals until attach.',
