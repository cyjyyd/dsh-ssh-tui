...
export const en: Record<string, string> = {
  ...
  'approval.autoOn': 'Auto-approval ON: low-risk commands approve; dangerous shapes (rm -rf, sudo, curl|sh, git push --force) auto-REJECT with the reason fed back to the model; unrecognized shapes go to the subagent-model reviewer, then ask while attached and reject when detached.',
  ...
  'help.intro2': 'Empty ↑/↓ selects cards (same as Ctrl+N/P); Enter expands (oversized bodies open a full view, Esc returns); Ctrl+R expands the latest card (or all, once a card is selected); Ctrl+T folds input. Slash suggestions and model lists keep 12 rows; ↑/↓ slides the window.',
