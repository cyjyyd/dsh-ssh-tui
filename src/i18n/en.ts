...
export const en: Record<string, string> = {
  ...
  'approval.statusAuto': 'Auto-approval on: {count} low-risk command(s) allowed automatically; dangerous ones still ask',
  ...
  'cmd.approval': 'Approval mode: auto-allow low-risk commands or ask every time',
