...
export const en: Record<string, string> = {
  ...
  'cmd.preset': 'Preset authoring: /preset lists; show <id> prints its rows; copy <from> <new-id> [name]; rename/describe edit the display name and description; delete removes a user preset',
