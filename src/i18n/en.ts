...
export const en: Record<string, string> = {
  ...
  'diag.rowTerminal': 'terminal: {label} ({family}) · mouse {mouse} · bracketed paste {paste} · alt screen {alt} · OSC52 {osc52} · OSC8 {osc8}',
  ...
  'copy.osc52Hint': 'This terminal ({terminal}) is not guaranteed to accept OSC 52 clipboard writes; if the clipboard did not change, select the text and copy manually, or use a terminal that supports OSC 52 (Windows Terminal, GNOME Terminal, Konsole).',
