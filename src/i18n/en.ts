...
export const en: Record<string, string> = {
  ...
  'cmd.mode': 'Switch agent preset (runs immediately: standard/minimal/ptc, etc.)',
  ...
  'cmd.compact': 'Compact conversation context: summarize older turns to save tokens (runs immediately)',
